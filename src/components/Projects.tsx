...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Interactive digital experience platform powered by React and Vite. Built lightning-fast application with modern JavaScript architecture and optimized build tooling. Implemented smooth user interactions with responsive design patterns and clean UI components. Leveraged Vite's HMR for exceptional development experience. Deployed with optimized performance metrics on Vercel.",
